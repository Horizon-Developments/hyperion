...
local base64 = (function()
  local a,b,c=string.byte,string.char,table.concat;local d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"local e={}for f=1,64 do e[a(d,f)]=f-1 end;local function g(h,i)local j=d;local k=#h%3;local l={}local m,n,o;local p={}local q,r=1,72;for f=1,#h,3 do m=a(h,f)n=a(h,f+1)or 0;o=a(h,f+2)or 0;p[1]=b(a(j,m>>2+1))p[2]=b(a(j,m<<4|(n>>4)&0x3f+1))p[3]=b(a(j,n<<2|(o>>6)&0x3f+1))p[4]=b(a(j,o&0x3f+1))l[#l+1]=c(p)q=q+4;if q>r then l[#l+1]="\n"q=1 end end;local s=#l;if l[s]=="\n"then s=s-1 end;if k==2 then l[s]=string.gsub(l[s],".$","=")elseif k==1 then l[s]=string.gsub(l[s],"..$","==")end;local t=c(l)if i then t=string.gsub(t,"%+","-")t=string.gsub(t,"/","_")t=string.gsub(t,"[%s=]","")end;return t end;local function u(t)local v=e;local w,x,y,z;local l={}local A={}t=string.gsub(t,"%-","+")t=string.gsub(t,"_","/")t=string.gsub(t,"[=%s]","")if t:find("[^0-9A-Za-z/+=]")then return nil,"invalid char"end;for f=1,#t,4 do w=v[a(t,f)]x=v[a(t,f+1)]if not w or not x then return nil,"invalid length"end;y=v[a(t,f+2)]z=v[a(t,f+3)]A[1]=b(w<<2|(x>>4))if not y then A[2]=nil;A[3]=nil;l[#l+1]=c(A)break end;A[2]=b(x<<4|(y>>2)&0xff)if not z then A[3]=nil;l[#l+1]=c(A)break end;A[3]=b(y<<6|z&0xff)l[#l+1]=c(A)end;return c(l)end;
  return{encode=g,decode=u}
end)()
local fiu = (function()
